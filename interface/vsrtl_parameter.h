...
class Parameter : public ParameterBase {
    static_assert(std::is_same<std::string, T>::value || std::is_same<bool, T>::value || std::is_same<int, T>::value ||
                      std::is_same<std::vector<int>, T>::value || std::is_same<std::vector<std::string>, T>::value,
