...
public:
    ...
    // Defines the variable @p name within the current scope, and returns a unique identifier associated with the
    // variable.
    ...
    void varInitVal(const std::string& ref, uint64_t value) { m_dumpVars[ref] = value; }
